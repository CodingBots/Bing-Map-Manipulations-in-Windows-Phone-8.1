...
namespace MapManipulations
{
    ...
    public sealed partial class Routes : Page
    {
        ...
        Geopoint point = null;
        private async void txtFromLocation_LostFocus(object sender, RoutedEventArgs e)
        {
            point = (await (new Geolocator()).GetGeopositionAsync()).Coordinate.Point;
            
            MapLocationFinderResult result = await MapLocationFinder.FindLocationsAsync(txtFromLocation.Text, point);
            try
            {
